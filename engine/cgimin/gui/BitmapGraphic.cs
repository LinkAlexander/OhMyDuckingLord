...
namespace cgimin.engine.gui
{
    public class BitmapGraphic
    {
        ...
        public BitmapGraphic(int textureID, int textureWidth, int textureHeight, int u1, int v1, int width, int height) : base()
        {
            ...
            if (program == -1)
            {
                program = ShaderCompiler.CreateShaderProgram("cgimin/gui/shader/BitmapFont_VS.glsl", "cgimin/gui/shader/BitmapGraphic_FS.glsl");                GL.BindAttribLocation(program, 0, "in_position");
